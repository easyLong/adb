...
class Config:
    ...
    KOL_TENPAY_EXTERNAL_READS_LOOKBACK_DAYS = _env_int("KOL_TENPAY_EXTERNAL_READS_LOOKBACK_DAYS", 5)
    ...
    WECHAT_DEVICE_SERIAL = _env("WECHAT_DEVICE_SERIAL", "APH0219701010623")
    WECHAT_SYNC_PAGES = _env_int("WECHAT_SYNC_PAGES", 12)
    WECHAT_SYNC_OUT_DIR = _env("WECHAT_SYNC_OUT_DIR", "exports/wechat")
    WECHAT_SYNC_LIMIT = _env_int("WECHAT_SYNC_LIMIT", 0)
    WECHAT_SYNC_PARSE_MODE = _env("WECHAT_SYNC_PARSE_MODE", "ocr")
    WECHAT_SYNC_CONTEXT_SIZE = _env_int("WECHAT_SYNC_CONTEXT_SIZE", 30)
    WECHAT_SCHEDULER_ENABLED = _env_bool("WECHAT_SCHEDULER_ENABLED", False)
    WECHAT_SCHEDULER_START_TIME = _env("WECHAT_SCHEDULER_START_TIME", "08:00")
    WECHAT_SCHEDULER_END_TIME = _env("WECHAT_SCHEDULER_END_TIME", "19:00")
    WECHAT_SCHEDULER_INTERVAL_MINUTES = _env_int("WECHAT_SCHEDULER_INTERVAL_MINUTES", 60)
    WECHAT_SCHEDULER_WORKDAYS = _env("WECHAT_SCHEDULER_WORKDAYS", "1,2,3,4,5")
    ...
    DEVICE_POOL_HOST_ID = _env("DEVICE_POOL_HOST_ID", "")
    DEVICE_LOCK_WAIT_SECONDS = _env_int("DEVICE_LOCK_WAIT_SECONDS", 3600)
    DEVICE_LOCK_POLL_SECONDS = _env_float("DEVICE_LOCK_POLL_SECONDS", 5.0)
    DEVICE_LEASE_SECONDS = _env_int("DEVICE_LEASE_SECONDS", 900)
    DEVICE_FAILURE_COOLDOWN_SECONDS = _env_int("DEVICE_FAILURE_COOLDOWN_SECONDS", 180)
