...
class Config:
    ...
    CHECK_LIMIT = _env_int("CHECK_LIMIT", 10)
    ...
    EXCEL_DETAIL_LIMIT = _env_int("EXCEL_DETAIL_LIMIT", 0)
    EXCEL_DETAIL_ALIPAY_LIMIT = _env_int("EXCEL_DETAIL_ALIPAY_LIMIT", 0)
    EXCEL_DETAIL_ANTFORTUNE_LIMIT = _env_int("EXCEL_DETAIL_ANTFORTUNE_LIMIT", 0)
    EXCEL_DETAIL_TENPAY_LIMIT = _env_int("EXCEL_DETAIL_TENPAY_LIMIT", 0)
    ...
    MAX_RECORDS_PER_RUN = _env_int("MAX_RECORDS_PER_RUN", 0)
