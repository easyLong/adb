...
class Config:
    ...
    # Keep the historical database name to avoid forcing an immediate data migration.
    ...
    USE_FRAMEWORK_TASKS_FOR_WORKFLOWS = _env_bool("USE_FRAMEWORK_TASKS_FOR_WORKFLOWS", False)
    USE_TASK_SUBMISSIONS_FOR_BATCH = _env_bool("USE_TASK_SUBMISSIONS_FOR_BATCH", True)
    ...
    EXCEL_BATCH_INPUT_PATH = _env("EXCEL_BATCH_INPUT_PATH", "")
    EXCEL_BATCH_OUTPUT_PATH = _env("EXCEL_BATCH_OUTPUT_PATH", "")
    EXCEL_BATCH_RESULT_JSONL_PATH = _env("EXCEL_BATCH_RESULT_JSONL_PATH", "")
    EXCEL_BATCH_SHEET_NAME = _env("EXCEL_BATCH_SHEET_NAME", "")
    EXCEL_BATCH_SOURCE_FILTER = _env("EXCEL_BATCH_SOURCE_FILTER", "")
    EXCEL_BATCH_ONLY_EMPTY = _env_bool("EXCEL_BATCH_ONLY_EMPTY", True)
    EXCEL_BATCH_LIMIT = _env_int("EXCEL_BATCH_LIMIT", 0)
    EXCEL_BATCH_ALIPAY_LIMIT = _env_int("EXCEL_BATCH_ALIPAY_LIMIT", 0)
    EXCEL_BATCH_ANTFORTUNE_LIMIT = _env_int("EXCEL_BATCH_ANTFORTUNE_LIMIT", 0)
    EXCEL_BATCH_TENPAY_LIMIT = _env_int("EXCEL_BATCH_TENPAY_LIMIT", 0)
    EXCEL_BATCH_SAVE_EVERY = _env_int("EXCEL_BATCH_SAVE_EVERY", 1)
    EXCEL_BATCH_COL_ACCOUNT_NAME = _env_int("EXCEL_BATCH_COL_ACCOUNT_NAME", 9)
    EXCEL_BATCH_COL_URL = _env_int("EXCEL_BATCH_COL_URL", 10)
    EXCEL_BATCH_COL_READ_COUNT = _env_int("EXCEL_BATCH_COL_READ_COUNT", 11)
    EXCEL_BATCH_COL_COMMENT_COUNT = _env_int("EXCEL_BATCH_COL_COMMENT_COUNT", 12)
    EXCEL_BATCH_COL_STATUS = _env_int("EXCEL_BATCH_COL_STATUS", 14)
    EXCEL_BATCH_COL_DURATION = _env_int("EXCEL_BATCH_COL_DURATION", 15)
    EXCEL_BATCH_COL_ERROR = _env_int("EXCEL_BATCH_COL_ERROR", 16)
    EXCEL_BATCH_COL_SOURCE = _env_int("EXCEL_BATCH_COL_SOURCE", 17)
    ...
    LEGACY_CACHE_FILE = BASE_DIR / ".alipay_scheme_cache.json"
