...
_CONFIG_ATTRS: dict[str, str] = {
    ...
    "DEVICE_POOL_HOST_ID": "DEVICE_POOL_HOST_ID",
    ...
    "DEVICE_FAILURE_COOLDOWN_SECONDS": "DEVICE_FAILURE_COOLDOWN_SECONDS",
...
_APP_BEHAVIOR_CONFIG_KEYS: tuple[str, ...] = (
    ...
    "DEVICE_FAILURE_COOLDOWN_SECONDS",
...
_DESCRIPTIONS.update(
    {
        ...
        "DEVICE_POOL_HOST_ID": "Logical worker host name for ADB device-pool isolation. Empty uses the local computer name.",
        "DEVICE_FAILURE_COOLDOWN_SECONDS": "Short cooldown after an ordinary crawl failure, so the next task can try another device.",
...
_DISPLAY_LABELS.update(
    {
        ...
        "DEVICE_POOL_HOST_ID": "Device pool host",
        "DEVICE_FAILURE_COOLDOWN_SECONDS": "Device failure cooldown",
