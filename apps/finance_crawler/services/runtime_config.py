...
_CONFIG_ATTRS: dict[str, str] = {
    ...
    "EXCEL_DETAIL_LIMIT": "EXCEL_DETAIL_LIMIT",
    "EXCEL_DETAIL_ALIPAY_LIMIT": "EXCEL_DETAIL_ALIPAY_LIMIT",
    "EXCEL_DETAIL_ANTFORTUNE_LIMIT": "EXCEL_DETAIL_ANTFORTUNE_LIMIT",
    "EXCEL_DETAIL_TENPAY_LIMIT": "EXCEL_DETAIL_TENPAY_LIMIT",
