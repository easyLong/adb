...
from apps.alipay_crawler.sinks.tencent_docs import TencentDocsSink
...
from apps.alipay_crawler.services.framework_events import (
    ...
    for idx, post in enumerate(posts, start=1):
        ...
        task_id, result_id = record_crawl_result_for_post(
            ...
            metrics={
                ...
                "tenpay_trade_details": result.get("tenpay_trade_details") or [],
                "tenpay_summary": result.get("tenpay_summary"),
                "tenpay_trade_detail_opened": result.get("tenpay_trade_detail_opened"),
