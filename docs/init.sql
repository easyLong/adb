...
VALUES
    ('alipay_profile_daily_metrics_v1', 'alipay', 'profile_daily_metrics', 'fans_count,growth_count,read_count', 'open_profile,capture_fans,open_exact_fans_if_abbreviated,scan_recent_posts,tap_post,capture_read_count,aggregate_max_recent_posts,writeback', '["fans_count","growth_count","read_count"]', '["open_profile","capture_fans","open_exact_fans_if_abbreviated","scan_recent_posts","tap_post","capture_read_count","aggregate_max_recent_posts","writeback"]', '{"fans_count":{"exact_if_abbreviated":true},"read_count":{"recent_posts_limit":3,"ocr":false},"holding":{"enabled":false}}', '{"read_count":{"source":"recent_posts","method":"max","max_posts":3},"growth_count":{"source":"previous_workday_fans_count"}}', 20, 'Alipay profile metrics: exact fans when needed, max read count from recent 3 posts.', 'system'),
    ('antfortune_profile_daily_metrics_v1', 'antfortune', 'profile_daily_metrics', 'fans_count,growth_count,read_count', 'open_profile,capture_fans,open_exact_fans_if_abbreviated,scan_recent_posts,tap_post,capture_read_count,aggregate_max_recent_posts,writeback', '["fans_count","growth_count","read_count"]', '["open_profile","capture_fans","open_exact_fans_if_abbreviated","scan_recent_posts","tap_post","capture_read_count","aggregate_max_recent_posts","writeback"]', '{"fans_count":{"exact_if_abbreviated":true},"read_count":{"recent_posts_limit":3,"ocr":false},"holding":{"enabled":false}}', '{"read_count":{"source":"recent_posts","method":"max","max_posts":3},"growth_count":{"source":"previous_workday_fans_count"}}', 20, 'Ant Fortune profile metrics: exact fans when needed, max read count from recent 3 posts.', 'system'),
    ('tenpay_profile_daily_metrics_v1', 'tenpay', 'profile_daily_metrics', 'fans_count,growth_count,read_count', 'open_profile,capture_fans,ocr_if_needed,scan_recent_posts,tap_post,capture_read_count,aggregate_max_recent_posts,writeback', '["fans_count","growth_count","read_count"]', '["open_profile","capture_fans","ocr_if_needed","scan_recent_posts","tap_post","capture_read_count","aggregate_max_recent_posts","writeback"]', '{"fans_count":{"exact_if_abbreviated":true,"ocr":true},"read_count":{"recent_posts_limit":3,"ocr":true},"holding":{"enabled":false}}', '{"read_count":{"source":"recent_posts","method":"max","max_posts":3},"growth_count":{"source":"previous_workday_fans_count"}}', 10, 'Tenpay profile metrics with OCR fallback.', 'system'),
    ('unknown_profile_daily_metrics_v1', 'unknown', 'profile_daily_metrics', 'fans_count,growth_count,read_count', 'open_profile,capture_fans,scan_recent_posts,tap_post,capture_read_count,aggregate_max_recent_posts,writeback', '["fans_count","growth_count","read_count"]', '["open_profile","capture_fans","scan_recent_posts","tap_post","capture_read_count","aggregate_max_recent_posts","writeback"]', '{"fans_count":{"exact_if_abbreviated":false},"read_count":{"recent_posts_limit":3,"ocr":false},"holding":{"enabled":false}}', '{"read_count":{"source":"recent_posts","method":"max","max_posts":3},"growth_count":{"source":"previous_workday_fans_count"}}', 0, 'Fallback profile metrics action profile.', 'system')
ON DUPLICATE KEY UPDATE
    action_combo = VALUES(action_combo),
    action_names_json = VALUES(action_names_json),
